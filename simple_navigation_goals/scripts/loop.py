...
class PatrolNav():
    def __init__(self):
        ...
        self.locations['three'] = Pose(Point(4.33081847411,  7.87543252813, 0.000), Quaternion(0.000, 0.000, -0.999114356415, 0.0420773431252))
        self.locations['four']  = Pose(Point(4.19707936356, 6.85442485998, 0.000), Quaternion(0.000, 0.000, 0.997792352715, 0.0664109995628))
        self.locations['five']  = Pose(Point(0.220589099314, 7.76813161799, 0.000), Quaternion(0.000, 0.000,0.985441957522,0.170012200606))
